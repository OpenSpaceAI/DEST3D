...
def parse_predictions_with_raw_pred(end_points, config_dict, prefix="", size_cls_agnostic=False):
    """ Parse predictions to OBB parameters and suppress overlapping boxes
    ...
    return pred_mask, pred_corners_3d_upright_camera, obj_prob, pred_sem_cls, sem_cls_probs
